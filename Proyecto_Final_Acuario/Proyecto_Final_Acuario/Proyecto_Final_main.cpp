...
glm::vec3 pointLightPositions[] = {  //Posicion de los spot light
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.cutOff"), glm::cos(glm::radians(12.f)));
